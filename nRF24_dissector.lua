----------------------------------------
-- script-name: nRF24_dissector.lua
--
...
function nrf24.dissector(tvbuf,pktinfo,root)
    ...
    pktinfo.cols.info:set( string.format("Adr: %s, Len: %2d, Pld: %s", adrRange, plLengthValue, shiftedRemainder(0,plLengthValue) ) )
